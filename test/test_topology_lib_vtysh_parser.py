...
def test_parse_show_ntp_status():
    raw_result = """NTP has been enabled
NTP Authentication has been disabled
Uptime: 2343 second(s)
Synchronized to NTP Server 192.168.1.100 at stratum 4
Poll interval = 64 seconds
Time accuracy is within 17.811 seconds
