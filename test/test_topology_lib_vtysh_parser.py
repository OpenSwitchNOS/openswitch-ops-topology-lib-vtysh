...
access-list ip ip_acl
    10 permit tcp 1.2.3.4/255.255.255.0 4.3.2.1/255.255.255.0 log
    20 deny tcp 1.2.3.4/255.255.255.0 4.3.2.1/255.255.255.0 count
    40 deny udp any neq 10 any range 10 100
interface 1
