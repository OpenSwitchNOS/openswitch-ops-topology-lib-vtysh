...
def copy_core_dump(
        enode, deamonname, instance_id='', transport='', username='',
    ...
    ::
        ...
        # copy core-dump {deamonname}

    :param deamonname: Name of the deamon name or kernel [Mandatory]
    :param instance_id: instance_id ONLY for deamon,NOT FOR Kernel
