...
def parse_show_vlan_internal(raw_result):
    ...
    :return: The parsed result of the show vlan internal command in a \
        dictionary of the form. Returns None if no vlan internal found or \
        empty dictionary:
...
__all__ = [
    ...
    'parse_show_qos_dscp_map', 'parse_show_vlan_internal',
    'parse_show_qos_queue_profile', 'parse_show_vrf',
